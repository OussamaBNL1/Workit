    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
          Connecting talented freelancers with clients looking for quality work.
        </p>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our mission is to create a platform where talented freelancers can showcase their skills and connect with businesses looking for quality services. We believe in building a community that values fair opportunities, transparent communication, and meaningful work.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* How We Started */}
      <div className="bg-gray-50 py-12 rounded-lg my-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div>
              ...
              <p className="mt-3 text-lg text-gray-500">
                WorkiT began with a simple idea: create a platform that makes it easy for skilled freelancers to find work and for businesses to find talent. Founded in 2023, we've grown from a small community to a thriving marketplace connecting professionals around the world.
              </p>
              <p className="mt-3 text-lg text-gray-500">
                Our team is passionate about creating opportunities for everyone. We believe that talent is universal, but opportunity isn't always accessible. That's why we built WorkiT – to level the playing field and give everyone a chance to succeed.
              </p>
            </div>
              ...
              <div className="bg-primary-600 rounded-lg p-8 text-white">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span>Quality work and fair compensation</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-6 w-6 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span>Opportunity for everyone, everywhere</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-6 w-6 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
